    ...
    <div className='div-direction'>
      <div className='resumeSize'>
       ...
       {myPicture ? <img src={pictureBox} onClick={closePicture} className='pictureWork2'/>:
        ...
        <h3 className='abot_me'> fullStack web application(React.js,typeScript node.js, mySql and MongooseDB) </h3>
        ...
        <h3 className='biodata'onClick={biodata} >BIO DATA:</h3>
        {information && <div className='biodata1'>
          ...
          <h3 className='school'onClick={school} >EDUCATIONAL INSTITUTION:</h3>
          ...
          <li className='school_attends'>Gaskiya College, Ijora Badia, Lagos.</li>
           <li className='school_attends'>Autonet Computer Institution</li>
            ...
            <h3 className='qualification'onClick={qualification} >QUALIFICATIONS:</h3>
            {myqualification && <div className='mylist'>
              ...
              <h3 className='workExpirience'onClick={workExpirience} >WORK EXPERIENCE:</h3>
              {myWorkExpirience && <div className='mylist'>
                ...
                <h3 className='hobbies'onClick={hobbies} >HOBBIES:</h3>
